...
interface IMarket {
    function createMarket(address creator, address marketToken, address resolver, uint256 minDeposit, string memory title)
        external
    ...
    function tradeProposal(uint256 proposalId, address trader, bool yesOrNo, bool zeroForOne, int256 amountIn) external;
